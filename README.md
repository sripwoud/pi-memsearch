...
| `PI_MEMSEARCH_STORE_CMD`          | unset                                  | Command printing the store path (`memory-dir`), the collection (`collection`) and optionally the index-state dir (`state-dir`); outranks `MEMSEARCH_DIR` |
